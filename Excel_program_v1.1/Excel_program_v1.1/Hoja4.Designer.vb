...
Partial Public NotInheritable Class Hoja4
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Hoja4", "Hoja4")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Hoja4 As Hoja4
    
    Friend Shared Property Hoja4() As Hoja4
        Get
            Return _Hoja4
        End Get
        Set
            If (_Hoja4 Is Nothing) Then
                _Hoja4 = value
            Else
