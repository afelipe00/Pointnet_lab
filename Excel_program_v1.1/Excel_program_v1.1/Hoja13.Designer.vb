...
Partial Public NotInheritable Class Hoja13
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Hoja13", "Hoja13")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Hoja13 As Hoja13
    
    Friend Shared Property Hoja13() As Hoja13
        Get
            Return _Hoja13
        End Get
        Set
            If (_Hoja13 Is Nothing) Then
                _Hoja13 = value
            Else
