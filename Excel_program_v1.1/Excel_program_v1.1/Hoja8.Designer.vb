...
'''
<Microsoft.VisualStudio.Tools.Applications.Runtime.StartupObjectAttribute(11),  _
...
Partial Public NotInheritable Class Hoja8
    Inherits Microsoft.Office.Tools.Excel.WorksheetBase
    
    Friend WithEvents Tabla5 As Microsoft.Office.Tools.Excel.ListObject
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Hoja8", "Hoja8")
    End Sub
    ...
    Private Sub InitializeControls()
        Me.Tabla5 = Globals.Factory.CreateListObject(Nothing, Nothing, "Hoja8:Tabla5", "Tabla5", Me)
    End Sub
    ...
    Private Sub InitializeComponents()
        ...
        'Tabla5
        '
        Me.Tabla5.DefaultDataSourceUpdateMode = System.Windows.Forms.DataSourceUpdateMode.Never
        '
        'Hoja8
        '
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Hoja8 As Hoja8
    
    Friend Shared Property Hoja8() As Hoja8
        Get
            Return _Hoja8
        End Get
        Set
            If (_Hoja8 Is Nothing) Then
                _Hoja8 = value
            Else
