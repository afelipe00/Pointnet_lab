...
Partial Public NotInheritable Class Hoja2
    ...
    Friend WithEvents Tabla1 As Microsoft.Office.Tools.Excel.ListObject
    ...
    Private Sub InitializeControls()
        Me.Tabla1 = Globals.Factory.CreateListObject(Nothing, Nothing, "Hoja2:Tabla1", "Tabla1", Me)
    End Sub
    ...
    Private Sub InitializeComponents()
        ...
        'Tabla1
        '
        Me.Tabla1.DefaultDataSourceUpdateMode = System.Windows.Forms.DataSourceUpdateMode.Never
        '
        'Hoja2
        '
    End Sub
