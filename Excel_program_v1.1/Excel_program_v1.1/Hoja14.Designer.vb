...
Partial Public NotInheritable Class Hoja14
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Hoja14", "Hoja14")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Hoja14 As Hoja14
    
    Friend Shared Property Hoja14() As Hoja14
        Get
            Return _Hoja14
        End Get
        Set
            If (_Hoja14 Is Nothing) Then
                _Hoja14 = value
            Else
