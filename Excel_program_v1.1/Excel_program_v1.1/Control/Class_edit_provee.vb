Public Class Class_edit_provee
    Dim funcion = New Class_funciones

    Public Function espacios_vacios(ByRef combox As ComboBox, ByRef box2 As TextBox, ByRef box3 As TextBox, ByRef box4 As TextBox,
                                    ByRef box5 As TextBox, ByRef label1 As Label, ByVal hoja As String)
        Dim vector() As Object = {combox, box2, box5, box3, box4}
        ...
        If estado = 0 Then
            Call mod_provee(combox, box2, box3, box4, box5, label1, hoja)
        End If
        Return Nothing
    End Function
    Public Function mod_provee(ByRef combox As ComboBox, ByRef box2 As TextBox, ByRef box3 As TextBox,
    ...
    Public Function eliminar_prod(ByRef combox As ComboBox, ByRef box2 As TextBox, ByRef box3 As TextBox, ByRef box4 As TextBox,
                                  ByRef box5 As TextBox, ByVal hoja As String, ByRef label1 As Label)
        Dim workbook = Globals.ThisWorkbook.Application
        Dim funcion = New Class_funciones
    ...
    Public Function llenar_textos(ByRef combox As ComboBox, ByRef text2 As TextBox, ByRef text3 As TextBox, ByRef text4 As TextBox,
                                  ByRef text5 As TextBox, ByVal hoja As String, ByRef label1 As Label)
        Dim workbook = Globals.ThisWorkbook.Application
        Dim funcion = New Class_funciones
        Dim fila As Long
    ...
    Public Function limpiar_casillas(ByRef combox As ComboBox, ByRef box2 As TextBox, ByRef box3 As TextBox, ByRef box4 As TextBox, ByRef box5 As TextBox)
        combox.Text = ""
        box2.Text = ""
        box3.Text = ""
        box4.Text = ""
