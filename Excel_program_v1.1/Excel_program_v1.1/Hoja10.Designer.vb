...
'''
<Microsoft.VisualStudio.Tools.Applications.Runtime.StartupObjectAttribute(13),  _
...
Partial Public NotInheritable Class Hoja10
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Hoja10", "Hoja10")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Hoja10 As Hoja10
    
    Friend Shared Property Hoja10() As Hoja10
        Get
            Return _Hoja10
        End Get
        Set
            If (_Hoja10 Is Nothing) Then
                _Hoja10 = value
            Else
