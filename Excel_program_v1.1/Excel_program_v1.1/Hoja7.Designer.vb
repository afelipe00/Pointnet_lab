...
'''
<Microsoft.VisualStudio.Tools.Applications.Runtime.StartupObjectAttribute(10),  _
...
Partial Public NotInheritable Class Hoja7
    Inherits Microsoft.Office.Tools.Excel.WorksheetBase
    
    Friend WithEvents Tabla2 As Microsoft.Office.Tools.Excel.ListObject
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Hoja7", "Hoja7")
    End Sub
    ...
    Private Sub InitializeControls()
        Me.Tabla2 = Globals.Factory.CreateListObject(Nothing, Nothing, "Hoja7:Tabla2", "Tabla2", Me)
    End Sub
    ...
    Private Sub InitializeComponents()
        ...
        'Tabla2
        '
        Me.Tabla2.DefaultDataSourceUpdateMode = System.Windows.Forms.DataSourceUpdateMode.Never
        '
        'Hoja7
        '
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Hoja7 As Hoja7
    
    Friend Shared Property Hoja7() As Hoja7
        Get
            Return _Hoja7
        End Get
        Set
            If (_Hoja7 Is Nothing) Then
                _Hoja7 = value
            Else
